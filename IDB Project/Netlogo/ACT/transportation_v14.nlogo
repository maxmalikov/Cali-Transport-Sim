...
to update-satisfaction
  ask people
   [
    ...
    set satisfaction-maxitaxi (w-buy * cost-buy-taxi + w-ope * cost-op-taxi + w-saf * safety-taxi + w-sec * security-taxi + w-com * comfort-taxi + w-tim * time-taxi + w-pol * pollution-tot + w-conv * convinience-taxi)
