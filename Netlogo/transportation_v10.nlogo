  ...
  while [y <= 23] [
    ...
    if ctype1 = [1][
      ...
      ask patches with [PID = y and occupied? = false and centroid? = true][
        ...
        let a item 0  m1524 / 10
        let b item 0  f1524 / 10
        let c item 0  m2459 / 10
        let d item 0  f2459 / 10
        let f item 0  m60 / 10
        let g item 0  f60 / 10
    ...
    if ctype1 = [3][
      ...
      ask patches with [PID = y and occupied? = false and centroid? = true][
        ...
        let a item 0  m1524 / 10 ; Está dividido entre 10 para correrlo con menos gente y poder hacer pruebas más rápido
        let b item 0  f1524 / 10
        let c item 0  m2459 / 10
        let d item 0  f2459 / 10
        let f item 0  m60 / 10
...
to commute
  ...
  [
    ...
    set density (equiv-cars / 90  ) ;(base case: 3 equiv cars x 9 patches = 27 or 4 equiv cars x 9 patches = 36)
 ...
 ; effect of road accidents
    ...
    let accident-congestion 1
     if accidents-nearby > 0
      [set accident-congestion 0.9]  ; factor that reduces the speed representing the effect of an accident on the road
